...
BASES DE DATOS:
    ...
    VISTAS:
        ...
        SELECT 
            ip.product_id,
            ip.total_quantity,
            COALESCE(ips.quantity_sold,0) quantity_sold,
            COALESCE(ips.total_amount,0) total_amount
        FROM(
    ...
    -- CAMBIOS/REESTRUCTURACIONES:
        -- 22/12/2023
            -- REAJUSTES
                ...
                ALTER TABLE IF EXISTS public.suppliers ADD COLUMN address text;
                ALTER TABLE IF EXISTS public.suppliers ADD COLUMN phone_number character varying(15);
                ALTER TABLE IF EXISTS public.products RENAME key TO sku;
                ALTER TABLE IF EXISTS public.products ADD COLUMN description text;
            -- TABLAS
                -- Generated by the database client.
                ...
                CREATE VIEW view_payment_types AS
                SELECT * FROM payment_types where deleted_at is null;
    CONSULTAS:
